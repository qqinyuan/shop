...
要用.gitignore文件，生成的，然后在webstorm软件内需要加上.idea，react生成的
...
然后在webstorm的terminal窗口内，输入命令行

```shell
//生成本地仓库                                                       
E:\js\code\project\shop>git init
Initialized empty Git repository in E:/js/code/project/shop/.git/

E:\js\code\project\shop>git add *
...各种warning
...
//这个其实是编码格式的问题，说是依次运行下列代码就行了，但是没有成功
//git config  core.quotepath off
//git config  --unset i18n.logoutputencoding
//git config  --unset i18n.commitencoding
E:\js\code\project\shop>git config core.quotepath off
E:\js\code\project\shop>git config --unset i18n.logoutputencoding
E:\js\code\project\shop>git config --unset i18n.commitencoding
E:\js\code\project\shop>git commit -m "init shop"
[master (root-commit) 1639528] init shop
 114 files changed, 26116 insertions(+)
 create mode 100644 .idea/.name
 create mode 100644 .idea/codeStyleSettings.xml
 create mode 100644 .idea/dictionaries/wxf.xml
 create mode 100644 .idea/encodings.xml
 create mode 100644 .idea/jsLibraryMappings.xml
 create mode 100644 .idea/libraries/Generated_files.xml
 create mode 100644 .idea/misc.xml
 create mode 100644 .idea/modules.xml
 create mode 100644 .idea/shop.iml
 create mode 100644 .idea/vcs.xml
 create mode 100644 .idea/watcherTasks.xml
 create mode 100644 .idea/workspace.xml
 create mode 100644 Images/090A3771-0127-4D88-B567-D15E39FBEE08.large.JPG
 create mode 100644 Images/1611CC2D-4F70-4B75-A66E-7D1F5362A416.large.JPG
 create mode 100644 Images/21A3EB33-D90C-4CCE-BF5E-1B1A791EFDD5.large.JPG
 create mode 100644 Images/2E24B2C3-4EA5-4F39-9A83-4CF1E4AE6F43.large.JPG
 create mode 100644 Images/food.png
 create mode 100644 Images/login.png
 create mode 100644 Images/msite.png
 create mode 100644 Images/profile.png
 create mode 100644 README.md
 create mode 100644 shop-client/.babelrc
 create mode 100644 shop-client/.editorconfig
 create mode 100644 shop-client/.eslintignore
 create mode 100644 shop-client/.eslintrc.js
 create mode 100644 shop-client/.gitignore
 create mode 100644 shop-client/.postcssrc.js
 create mode 100644 shop-client/README.md
 create mode 100644 shop-client/build/build.js
 create mode 100644 shop-client/build/check-versions.js
 create mode 100644 shop-client/build/logo.png
 create mode 100644 shop-client/build/utils.js
 create mode 100644 shop-client/build/vue-loader.conf.js
 create mode 100644 shop-client/build/webpack.base.conf.js
 create mode 100644 shop-client/build/webpack.dev.conf.js
 create mode 100644 shop-client/build/webpack.prod.conf.js
 create mode 100644 shop-client/config/dev.env.js
 create mode 100644 shop-client/config/index.js
 create mode 100644 shop-client/config/prod.env.js
 create mode 100644 shop-client/index.html
 create mode 100644 shop-client/package-lock.json
 create mode 100644 shop-client/package.json
 create mode 100644 shop-client/src/App.vue
 create mode 100644 shop-client/src/api/ajax-compiled.js
 create mode 100644 shop-client/src/api/ajax-compiled.js.map
 create mode 100644 shop-client/src/api/ajax.js
 create mode 100644 shop-client/src/api/index-compiled.js
 create mode 100644 shop-client/src/api/index-compiled.js.map
 create mode 100644 shop-client/src/api/index.js
 create mode 100644 shop-client/src/common/stylus/mixins.styl
 create mode 100644 shop-client/src/components/AlertTip/AlertTip.vue
 create mode 100644 shop-client/src/components/CartControl/CartControl.vue
 create mode 100644 shop-client/src/components/Food/Food.vue
 create mode 100644 shop-client/src/components/FooterGuide/FooterGuide.vue
 create mode 100644 shop-client/src/components/FooterGuide/FooterGuide2.vue
 create mode 100644 shop-client/src/components/HeaderTop/HeaderTop.vue
 create mode 100644 shop-client/src/components/ShopCart/ShopCart.vue
 create mode 100644 shop-client/src/components/ShopHeader/ShopHeader.vue
 create mode 100644 shop-client/src/components/ShopList/ShopList.vue
 create mode 100644 shop-client/src/components/ShopList/images/bread.jpg
 create mode 100644 shop-client/src/components/ShopList/images/fish.jpg
 create mode 100644 shop-client/src/components/ShopList/images/meat.jpg
 create mode 100644 shop-client/src/components/ShopList/images/rice.jpg
 create mode 100644 shop-client/src/components/ShopList/images/shop_back.svg
 create mode 100644 shop-client/src/components/Star/Star.vue
 create mode 100644 shop-client/src/components/Star/images/star24_half@2x.png
 create mode 100644 shop-client/src/components/Star/images/star24_half@3x.png
 create mode 100644 shop-client/src/components/Star/images/star24_off@2x.png
 create mode 100644 shop-client/src/components/Star/images/star24_off@3x.png
 create mode 100644 shop-client/src/components/Star/images/star24_on@2x.png
 create mode 100644 shop-client/src/components/Star/images/star24_on@3x.png
 create mode 100644 shop-client/src/components/Star/images/star36_half@2x.png
 create mode 100644 shop-client/src/components/Star/images/star36_half@3x.png
 create mode 100644 shop-client/src/components/Star/images/star36_off@2x.png
 create mode 100644 shop-client/src/components/Star/images/star36_off@3x.png
 create mode 100644 shop-client/src/components/Star/images/star36_on@2x.png
 create mode 100644 shop-client/src/components/Star/images/star36_on@3x.png
 create mode 100644 shop-client/src/components/Star/images/star48_half@2x.png
 create mode 100644 shop-client/src/components/Star/images/star48_half@3x.png
 create mode 100644 shop-client/src/components/Star/images/star48_off@2x.png
 create mode 100644 shop-client/src/components/Star/images/star48_off@3x.png
 create mode 100644 shop-client/src/components/Star/images/star48_on@2x.png
 create mode 100644 shop-client/src/components/Star/images/star48_on@3x.png
 create mode 100644 shop-client/src/main.js
 create mode 100644 shop-client/src/pages/Login/Login.vue
 create mode 100644 shop-client/src/pages/Login/images/captcha.svg
 create mode 100644 shop-client/src/pages/MSite/MSite.vue
 create mode 100644 shop-client/src/pages/MSite/images/msite_back.svg
 create mode 100644 shop-client/src/pages/Order/Order.vue
 create mode 100644 shop-client/src/pages/Order/images/order/person.png
 create mode 100644 shop-client/src/pages/Profile/Profile.vue
 create mode 100644 shop-client/src/pages/Search/Search.vue
 create mode 100644 shop-client/src/router/index.js
 create mode 100644 shop-client/static/.gitkeep
 create mode 100644 shop-client/static/css/reset.css
 create mode 100644 shop-server/.gitignore
 create mode 100644 shop-server/API.md
 create mode 100644 shop-server/api/ajax.js
 create mode 100644 shop-server/app.js
 create mode 100644 shop-server/bin/www
 create mode 100644 shop-server/data/index_category.json
 create mode 100644 shop-server/data/shops.json
 create mode 100644 shop-server/db/models.js
 create mode 100644 shop-server/package-lock.json
 create mode 100644 shop-server/package.json
 create mode 100644 shop-server/public/stylesheets/style.css
 create mode 100644 shop-server/routes/index.js
 create mode 100644 shop-server/routes/users.js
 create mode 100644 shop-server/util/sms_util.js
 create mode 100644 shop-server/views/error.ejs
 create mode 100644 shop-server/views/index.ejs
 create mode 100644 好处不贵外卖.postman_collection.json                                                                                                                                                                              
 create mode 100644 笔记总结.md                                                                                                                                                                                                      
 create mode 100644 项目开发流程.md                                                                                                                                                                                                  

Warning: Your console font probably doesn't support Unicode. If you experience strange characters in the output, consider switching to a TrueType font such as Consolas!

//下一步创建远程仓库，在giuhub上
//create repositories,写上名字说明，然后在打开的页面上复制下面的代码到terminal
E:\js\code\project\shop>git remote add origin https://github.com/qqinyuan/shop.git
//先关联再推送本地仓库到远程仓库上
E:\js\code\project\shop>git push origin master
Enumerating objects: 155, done.
Counting objects: 100% (155/155), done.
Delta compression using up to 4 threads.
Compressing objects: 100% (128/128), done.
Writing objects: 100% (155/155), 1.28 MiB | 158.00 KiB/s, done.
Total 155 (delta 12), reused 0 (delta 0)
remote: Resolving deltas: 100% (12/12), done.
To https://github.com/qqinyuan/shop.git
 * [new branch]      master -> master

E:\js\code\project\shop>

```

之后可以不断地写代码，更新到github上
...
```bash
#在Github新建Vue-Shop项目,然后clone到本地
...
- 三种方式：unicode,symbol,font-class（推荐）引用
...
- 父级引用：使用字符&指向父选择器
- 变量：
  + 定义变量：name=value   如：mainColor = #0982c1
  + 引用变量：name               如：color mainColor
  + name可以没有前缀要求，但最好以$开头（好识别）
...
- ESLint是一个代码规范检查工具，基本已经替代原来的JSLint
...
- 解决点击延迟响应0.3s问题
  ...
  http://www.cnblogs.com/lyyguniang/p/9284968.html
...
http://www.cnblogs.com/SamWeb/p/6610733.html
  ...
  <section class="msite">
    ...
    <header class="header">
      ...
      <span class="header_title">
        <span class="header_title_text ellipsis">电子科技大学沙河校区（建设路二段）</span>
      </span>
...
7. 最后在Msite.vue中import引入商家列表组件并注册使用，同HeaderTop
...
端口号在shop-server/bin/www的`var port = normalizePort(process.env.PORT || '4000');`
...
- ### 16.4 打包文件分析与优化
  ...
  - 启用打包可视化: `npm run build --report` 可以根据可视化文件分析页面对项目进行优化
    ...
    第一次生成的webpack-bundle-analyzer（802.38KB），用的moment日期过滤器

  ![build1](E:\js\笔记\shop\images\build1.PNG)

  

  第二次生成的webpack-bundle-analyzer（577.3KB），用的date-fns日期过滤器

  `npm install --save date-fns`

  ![build2](E:\js\笔记\shop\images\build2.PNG)
