...
export default {
  data () {
    return {
      onlyShowText: true, // true只看有文本内容的，是否只显示有文本的
      selectType: 2 // 选择的评价类型：2代表全部，1不满意，0满意
    }
  },
  mounted () {
  ...
  computed: {
    ...
    filterRatings () {
      ...
      return ratings.filter(rating => {
        ...
        *   selectType：0/1/2
        *   rateType: 0/1
        *   selectType === 2或selectType === rateType结果为真
        * 条件2：
        *   onlyShowText: true/false
        *   text: 有值/没值
        *   onlyShowText === false则对text没要求，为真，取!onlyShowText
        *   或onlyShowText === true则要求text.length > 0
        * */
