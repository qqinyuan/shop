      ...
      <form @submit.prevent="login">
        <div :class="{on: loginWay}">
          ...
          <section class="login_hint">
            温馨提示：未注册好吃不贵外卖帐号的手机号，登录时将自动注册，且代表已同意
...
export default {
  ...
  // rightPhone计算属性，根据phone的结果得出
  computed: {
    rightPhone () {
      // 正则对象//; 以1开头^1; 10个数字{10}; 结尾$; 方法test
  ...
  methods: {
    ...
    async login () {
      ...
      if (result.code === 0) {
        ...
        const msg = result.msg
        this.getCaptcha() // 输入密码啥的错误后，需要重新加载一下
        this.showAlert(msg)
      }
    },
    showAlert (alertText) {
